...
<template>
  <div class='login-wrap'>
    <div class="login-inner">
      <div class="logo">
        <img src="../../../images/wallhaven-2eqk86.png"
             alt="">
      </div>
      <div class="login-tab">
        <a href="javascript:;"
           :class="{active:loginFlag}"
           @click="changeTab">短信登录</a>
        <a href="javascript:;"
           :class="{active:!loginFlag}"
           @click="changeTab">账号登录</a>
      </div>
      <div class="login-content">
        <div v-if="loginFlag">
          <section>
            ...
            <button v-if="!num"
                    class="getcode"
                    @click="getcodeFn">获取验证码</button>
            <button disabled
                    v-else
                    class="getcode">已发送{{}}</button>
          </section>
          <section>
            <input type="tel"
                   placeholder="验证码"
        ...
        <div v-else>
          ...
          <section>
            ...
            <input type="text"
                   ...
                   placeholder="密码"
                   v-model="pass" />
            <button v-if="hidePass"
                    class="getcode iconfont icon-yincang"
                    @click="showHidePass"></button>
            <button v-else
